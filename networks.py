...
def vgg_encoder(target_input_size=None):
    def feature_encoder(input_tensor):
        ...
        feature_map_temp = concatenate([original_encoder.get_layer('block5_pure_conv1').output,
                                        original_encoder.get_layer('block5_relu1').output,
                                        original_encoder.get_layer('block5_relu2').output,
                                        original_encoder.get_layer('block5_pure_conv3').output,
                                        original_encoder.get_layer('block5_relu4').output], axis=3)
